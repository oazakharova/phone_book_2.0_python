class Contact:
    ...
    def __str__(self):
        # dunder-метод для красивого отображения информации об объекте класса для пользователей (например, для ф-ций print, str)
...
class PhoneBook:
    ...
    def open(self):
        ...
        for contact in data:
            ...
            # * => что мы берем каждый элемент отдельно
